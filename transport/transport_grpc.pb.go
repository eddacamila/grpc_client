...
const (
	TransportService_SendOperationalData_FullMethodName = "/transport.TransportService/SendOperationalData"
)
...
type TransportServiceClient interface {
	SendOperationalData(ctx context.Context, in *OperationalData, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *transportServiceClient) SendOperationalData(ctx context.Context, in *OperationalData, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, TransportService_SendOperationalData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransportServiceServer interface {
	SendOperationalData(context.Context, *OperationalData) (*Response, error)
...
func (UnimplementedTransportServiceServer) SendOperationalData(context.Context, *OperationalData) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendOperationalData not implemented")
}
...
func _TransportService_SendOperationalData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OperationalData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransportServiceServer).SendOperationalData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportService_SendOperationalData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServiceServer).SendOperationalData(ctx, req.(*OperationalData))
	}
...
var TransportService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendOperationalData",
			Handler:    _TransportService_SendOperationalData_Handler,
		},
	},
